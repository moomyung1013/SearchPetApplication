...
class RegisterViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun requestList(image: String, place: String, place2: String, kind: String, variety: String, gender: String, safe: String, phone: String){
        val url: String = "$SERVER_URL/register"
